...
public class SignaturePad extends View {
    ...
    public SignaturePad(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mMaxWidth = a.getDimensionPixelSize(R.styleable.SignaturePad_maxWidth, convertDpToPx(10));
            mVelocityFilterWeight = a.getFloat(R.styleable.SignaturePad_velocityFilterWeight, 10.0f);
