...
public abstract class PageView extends ViewGroup {
	...
	public void setPage(int page, PointF size) {
		...
		Log.e("myitm","mParentSize.x:"+mParentSize.x + " size.x:"+size.x + " mParentSize.y:"+mParentSize.y + " size.y:"+size.y);
		mSourceScale = Math.min(mParentSize.x / size.x, mParentSize.y / size.y);
		Point newSize = new Point((int)(size.x*mSourceScale), (int)(size.y*mSourceScale));
		//Point newSize = new Point((int)(mParentSize.x), (int)(mParentSize.x * size.y / size.x));
		mSize = newSize;
		Log.e("myitm","new size:"+ mSize.toString());
